...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('odoo.addons.base.models', 'odoo.addons.mail.controllers.mail', 'odoo.http', 'odoo.microkernel.ormapping.models')
    ...
    @mute_logger('odoo.addons.mail.controllers.mail', 'odoo.microkernel.ormapping.models', 'odoo.http')
