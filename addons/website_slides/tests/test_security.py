...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('odoo.ormapping.models', 'odoo.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('odoo.ormapping.models.unlink', 'odoo.addons.base.models.ir_rule', 'odoo.addons.base.models.ir_model')
